...
exports.getReservationConfirmPage = async function (req, res){
  ...
  try {
    ...
    info.push({rsvid:reservationid, prev:prev, name:name[0].Name, miraikuid:miraikuid[0].MiraikuID, age:age, disease:disease[0].DiseaseName,disease_reason:rsv_details[0].DiseaseReason , rsvdate:rsvdate, intime:intime, outtime:outtime, nursery:nursery[0].NurseryName , status:status, parent_name:parent_name, parent_tel:parent_tel, brothers:brothers, meal:meal[0].MealName, meal_details:meal_details[0].MealName, cramps:cramps, allergy:allergy})
...
exports.getReservationEntryPage = async function (req, res){
  ...
  try {
    ...
    info.push({allergy_bool:allergy_bool[0].Allergy, disease_list:disease_list, meal_list:meal_list,meal_details_list:meal_details_list, nursery_list:nursery_list, rsvid:reservationid, prev:prev, name:name[0].Name, miraikuid:miraikuid[0].MiraikuID, age:age, disease:disease[0].DiseaseName, disease_reason:rsv_details[0].DiseaseReason ,rsvdate:rsvdate, intime_hour:intime_hour, intime_mins:intime_mins, outtime_hour:outtime_hour, outtime_mins:outtime_mins, nursery:nursery[0].NurseryName , status:status, parent_name:parent_name, parent_tel:parent_tel, brothers:brothers, meal:meal[0].MealName, meal_details:meal_details[0].MealName, cramps:cramps, allergy:allergy})
